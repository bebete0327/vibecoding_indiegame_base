...
|--------------|---------------|
| 런타임만 다운로드해서 평가 | ❌ 무료 |
| Spine 에디터 없이 다른 Spine 프로젝트 파일로 작업 | ❌ 무료 |
| **게임을 배포/판매할 때** (내부 Spine 에셋 유무 무관하게 런타임이 포함됨) | ✅ **필수** |

→ https://esotericsoftware.com/spine-purchase

이 템플릿에는 Spine 에디터가 포함되지 않습니다. 런타임 바이너리만 자동 다운로드 가능.
